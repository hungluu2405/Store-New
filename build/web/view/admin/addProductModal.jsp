...
//        let author = $('#authorInput').val();
        ...
        if (name === '') {
            $('#nameError').html('Name must not be empty');
        }
...
//        }
        ...
        if (price === '') {
            $('#priceError').html('Price must not be empty');
        } else if (!$.isNumeric(price) || parseFloat(price) < 0) {
            $('#priceError').html('Price must be a number and not less than 0');
        }

        if (quantity === '') {
            $('#quantityError').html('Book quantity must not be empty');
        } else if (!$.isNumeric(quantity) || parseInt(price) < 0) {
            $('#priceError').html('Quantity must be a number and not less than 0');
        }
